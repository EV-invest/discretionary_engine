...
import { ContainerStyle, LabelStyle, SubGraph, Vertex } from "../interfaces.js";
 ...
 */
export declare const computeExcalidrawVertexStyle: (style: ContainerStyle) => Partial<Mutable<ExcalidrawVertexElement>>;
/**
 * Compute style for label
 */
export declare const computeExcalidrawVertexLabelStyle: (style: LabelStyle) => Partial<Mutable<ExcalidrawTextElement>>;
